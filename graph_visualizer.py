...
def generate_graph(incidents):
    ...
    plt.axhspan(1.5, 2.5, color="#B8F2E6", alpha=0.1)
    plt.axhspan(2.5, 3.5, color="#FAEDCB", alpha=0.1)
    plt.axhspan(3.5, 4.5, color="#F7C59F", alpha=0.1)
    plt.axhspan(4.5, 5.5, color="#F4A6A6", alpha=0.1)
